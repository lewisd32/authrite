...
public class DurationParserTest {
    ...
    public void testParseBasicDuration() {
        final Duration duration = new DurationParser().parse("28 days");
    ...
    public void testParseDurationWithMultipleComponents() {
        final Duration duration = new DurationParser().parse("28 days 3 hours");
        assertThat(duration,
    ...
    public void testParsePartialDurationWithTrailingText() {
        final ParseResult<Duration> result = new DurationParser().parsePartial("28 days later");
    ...
    public void testParsePartialDurationWithMoreTrailingText() {
        final ParseResult<Duration> result = new DurationParser().parsePartial("28 days later is a British movie");
        assertThat(result.getParsedObject(),
                   equalTo(Duration.ofMillis(TimeUnit.DAYS.toMillis(28))));
    ...
    private Deque<String> asTokenList(final String... items) {
